  ...
  return (
    <>
      ...
      >
        ...
        {/* 당첨이벤트 필터링 */}
        <Stack id='btn-event-my-check' direction={'row'} alignContent={'center'} alignItems={'center'}>
          <Checkbox
            name="winYn"
            disableRipple
            disableFocusRipple
      ...
      <List>
        {slickIndex === 1 &&
          eventStore.myEvents.map((event: IEventSnapshot, i: number) => {
            return (
              <ListItem
                key={`event-my-li-${event.eventSid}-${i}`}
                sx={{
