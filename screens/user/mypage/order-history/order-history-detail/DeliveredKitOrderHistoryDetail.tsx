...
import DeliveredKitOrderNoItems from './order-history-items/delivered-kit/DeliveredKitOrderNoItems';
import { pxToRem } from 'src/theme/typography';
import { useNavigate, useParams } from 'react-router';
import { PATH_ROOT } from 'src/routes/paths';
import ExchangeAlert from '../../exchange-alert/ExchangeAlert';
/*
 * ## DeliveredKitOrderHistoryDetail 설명
 * 키트 배송 완료
 */
export const DeliveredKitOrderHistoryDetail = observer(() => {
...
export default DeliveredKitOrderHistoryDetail;
