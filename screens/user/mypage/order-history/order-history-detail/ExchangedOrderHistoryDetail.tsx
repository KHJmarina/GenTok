...
import ExchangedOrderNoItems from './order-history-items/exchange/ExchangedOrderNoItems';
import { pxToRem } from 'src/theme/typography';
import { PATH_ROOT } from 'src/routes/paths';
import ExchangeAlert from '../../exchange-alert/ExchangeAlert';

/*
 * ## ExchangedOrderHistoryDetail 설명
 * 교환 완료
 */
export const ExchangedOrderHistoryDetail = observer(() => {
...
export default ExchangedOrderHistoryDetail;
