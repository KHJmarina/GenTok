...
export const CancelingOrderNoItems = observer(() => {
          ...
          <Stack>
            ...
            >
              ...
              >
                ...
                <Typography variant={'Kor_14_r'}>확인 중이에요. 조금만 기다려 주세요~</Typography>
              </Box>
            </Box>
...
export default CancelingOrderNoItems;
