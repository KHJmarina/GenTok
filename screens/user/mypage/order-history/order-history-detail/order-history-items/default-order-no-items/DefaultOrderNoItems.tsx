...
export const DefaultOrderNoItems = observer(() => {
  ...
  return (
    <>
          ...
          <Stack>
            ...
            >
              ...
              >
                ...
                <Typography variant={'Kor_14_r'}>주문 확인 중이에요. 조금만 기다려 주세요~</Typography>
              </Box>
            </Box>
              ...
              {/* <Box>
                <Box
                  ...
                  onClick={() => {navigate(PATH_ROOT.market.address, {state: {from: 'order-history'}})}}
                >
      ...
      <Divider sx={{ borderWidth: pxToRem(4), mt:pxToRem(20)}}></Divider>
    </>
  );
});

export default DefaultOrderNoItems;
