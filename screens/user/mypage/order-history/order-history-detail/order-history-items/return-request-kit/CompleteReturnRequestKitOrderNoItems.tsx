...
export const CompleteReturnRequestKitOrderNoItems = observer(() => {
  ...
  useEffect (() => {
    console.log(orderHistoryStore.orderHistory);
  },[])
            ...
            >
              ...
              <Box sx={{ display: 'flex' }}>
                <Box
                  ...
                  onClick={() => navigate(`${PATH_ROOT.user.mypage.deliveryTracking}/${orderHistoryStore.orderHistory?.orderNo}`)}
                >
...
export default CompleteReturnRequestKitOrderNoItems;
